<template>
  <section id="song-list" class="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-card/30">
...
const handleTitleClick = () => {
  // 设置URL hash
  window.location.hash = 'song-list'

  // 滚动到当前section
  const section = document.getElementById('song-list')
  if (section) {
